...
| `VINJECT-DEP-002` | Error | A required dependency has multiple possible providers. | Inject a more specific type, remove duplicate providers, or use a single shared alias/provider for the requested type. |
